...
{
    /// <summary>
    /// Sftp file access integration test cases
    /// !!!
    /// !!! Notice: Private sftp server info, please don't commit into version control.
    ...
    public class SftpFileAccessTests
    {
        ...
        private static string FtpBasePath => "upload/test/";

        #endregion

        public SftpFileAccessTests()
        {
